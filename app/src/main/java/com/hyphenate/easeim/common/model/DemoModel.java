...
public class DemoModel {
    ...
    public DemoDbHelper getDbHelper() {
        return DemoDbHelper.getInstance(ApplicationExlike.getInstance());
    }
...
//        }
    ...
    public boolean isFirstInstall() {
        SharedPreferences preferences = ApplicationExlike.getInstance().getSharedPreferences("first_install", Context.MODE_PRIVATE);
