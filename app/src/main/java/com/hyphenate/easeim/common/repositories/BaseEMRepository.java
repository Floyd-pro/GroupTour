...
public class BaseEMRepository {
     ...
     */
    public void initDb() {
        DemoDbHelper.getInstance(ApplicationExlike.getInstance()).initDb(getCurrentUser());
    }
    ...
    public EmUserDao getUserDao() {
        return DemoDbHelper.getInstance(ApplicationExlike.getInstance()).getUserDao();
    }
    ...
    public MsgTypeManageDao getMsgTypeManageDao() {
        return DemoDbHelper.getInstance(ApplicationExlike.getInstance()).getMsgTypeManageDao();
    }
    ...
    public InviteMessageDao getInviteMessageDao() {
        return DemoDbHelper.getInstance(ApplicationExlike.getInstance()).getInviteMessageDao();
    }
    ...
    public Context getContext() {
        return ApplicationExlike.getInstance().getApplicationContext();
    }
