...
//        callKitConfig.setRingFile(ringFile);
        ...
        //设置声网AgoraAppId
        callKitConfig.setAgoraAppId("c86e2240105e450eaa8c1587f7944a49");
    ...
    public void initPush(Context context) {
        if(EaseIM.getInstance().isMainProcess(context)) {
            ...
            //HMSPushHelper.getInstance().initHMSAgent(ApplicationExlike.getInstance());
     ...
     */
    public void killApp() {
        List<Activity> activities = ApplicationExlike.getInstance().getLifecycleCallbacks().getActivityList();
    ...
    public void logoutSuccess() {
        Log.d(TAG, "logout: onSuccess");
        setAutoLogin(false);
        DemoDbHelper.getInstance(ApplicationExlike.getInstance()).closeDb();
    }
    ...
    public DemoModel getModel(){
        if(demoModel == null) {
            demoModel = new DemoModel(ApplicationExlike.getInstance());
        }
        return demoModel;
    }
    ...
    public synchronized int deleteContact(String username) {
        ...
        DemoDbHelper helper = DemoDbHelper.getInstance(ApplicationExlike.getInstance());
