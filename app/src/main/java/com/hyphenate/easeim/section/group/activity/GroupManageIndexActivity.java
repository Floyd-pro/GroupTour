...
import com.zjnu.grouptour.activity.TeamDetailActivity;
...
public class GroupManageIndexActivity extends BaseInitActivity implements View.OnClickListener, EaseTitleBar.OnBackPressListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setTranslucentStatusTextMode(GroupManageIndexActivity.this, true);
...
//                GroupMemberAuthorityActivity.actionStart(mContext, groupId, GroupMemberAuthorityActivity.TYPE_BLACK);
                GroupMemberAuthorityActivity.actionStart(mContext, myTeam, groupId, GroupMemberAuthorityActivity.TYPE_BLACK);
                break;
...
//                GroupMemberAuthorityActivity.actionStart(mContext, groupId, GroupMemberAuthorityActivity.TYPE_MUTE);
                GroupMemberAuthorityActivity.actionStart(mContext, myTeam, groupId, GroupMemberAuthorityActivity.TYPE_MUTE);
                break;
            case R.id.btn_transfer ://移交
                GroupTransferActivity.actionStart(mContext, myTeam, groupId);
                break;
        }
    }
