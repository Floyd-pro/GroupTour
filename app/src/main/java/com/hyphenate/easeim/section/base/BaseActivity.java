...
import com.hyphenate.easeim.section.chat.activity.SingleChatSetActivity;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StatusBarUtils.setTranslucentStatusTextMode(BaseActivity.this, true);
        mContext = this;
    ...
    protected void finishOtherActivities() {
        UserActivityLifecycleCallbacks lifecycleCallbacks = ApplicationExlike.getInstance().getLifecycleCallbacks();
