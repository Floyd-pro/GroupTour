...
public class ChatPresenter extends EaseChatPresenter {
    ...
    private ChatPresenter() {
        appContext = ApplicationExlike.getInstance();
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        ...
        for (EMMessage message : messages) {
            ...
            if(!ApplicationExlike.getInstance().getLifecycleCallbacks().isFront()){
    ...
    public void onMessageRead(List<EMMessage> messages) {
        ...
        if(!(ApplicationExlike.getInstance().getLifecycleCallbacks().current() instanceof ChatActivity)) {
    ...
    private class ChatMultiDeviceListener implements EMMultiDeviceListener {
        ...
        public void onContactEvent(int event, String target, String ext) {
            ...
            DemoDbHelper dbHelper = DemoDbHelper.getInstance(ApplicationExlike.getInstance());
            String message = null;
            switch (event) {
