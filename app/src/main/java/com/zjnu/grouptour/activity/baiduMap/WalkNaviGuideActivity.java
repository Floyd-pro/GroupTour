 ...
 * @Description 步行导航
 */
public class WalkNaviGuideActivity extends BaseActivity {

    private final static String TAG = WalkNaviGuideActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            View view = mNaviHelper.onCreate(WalkNaviGuideActivity.this);
            if (view != null) {
                setContentView(view);
            }
        } catch (Exception e) {
        ...
        mNaviHelper.setWalkNaviStatusListener(new IWNaviStatusListener() {
            ...
            public void onWalkNaviModeChange(int mode, WalkNaviModeSwitchListener listener) {
                ...
                mNaviHelper.switchWalkNaviMode(WalkNaviGuideActivity.this, mode, listener);
            }
        ...
        boolean startResult = mNaviHelper.startWalkNavi(WalkNaviGuideActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == ArCameraView.WALK_AR_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_DENIED) {
                Toast.makeText(WalkNaviGuideActivity.this, "没有相机权限,请打开后重试", Toast.LENGTH_SHORT).show();
            } else if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                mNaviHelper.startCameraAndSetMapView(WalkNaviGuideActivity.this);
            }
        }
    }
}
