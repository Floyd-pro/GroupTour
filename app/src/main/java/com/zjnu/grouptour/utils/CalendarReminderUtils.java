...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "grouptour";
    private static String CALENDARS_ACCOUNT_NAME = "GROUPTOUR@grouptour.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.grouptour";
    private static String CALENDARS_DISPLAY_NAME = "提姆游账户";
