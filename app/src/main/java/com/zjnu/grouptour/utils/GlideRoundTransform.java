...
public class GlideRoundTransform extends BitmapTransformation {
    ...
    @Override
    public int hashCode() {
        return getClass().getName().hashCode() + radius * 10000 + diameter * 1000 + margin * 100 + cornerType.ordinal() * 10;
    }

    @Override
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        messageDigest.update((getClass().getName() + radius + diameter + margin + cornerType).getBytes(CHARSET));
    }
}