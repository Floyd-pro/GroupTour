...
public class StatusBarUtils {
    ...
    public static void setStatusBarMode(Activity activity, boolean isTextDark, int colorId) {
        ...
        if(!isTextDark) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                if(OSUtil.getSystem().equals(OSUtil.SYS_MIUI)) {
                    //小米MIUI系统
                    setMIUIStatusBarTextMode(activity, isTextDark);
                } else if(OSUtil.getSystem().equals(OSUtil.SYS_FLYME)) {
                    //魅族flyme系统
     ...
     */
    public static void setTranslucentStatusTextMode(Activity activity, boolean isTextDark) {
